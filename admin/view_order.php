...
var popUpWin=0;
function openNewTab(URLStr) {
  var newTab = window.open(URLStr, '_blank');
  newTab.focus();
}
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/logoku.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                   ...
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Restaurant</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_restaurant.php">All Restaurants healthyfood</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_restaurant.php">Add Restaurant healthyfood</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_menu.php">All Menues HF</a></li>
								<li><a href="add_menu.php">Add Menu healthyfood</a></li>
        ...
        <div class="page-wrapper">
                                           ...
                                           <?php
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onclick="openNewTab('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
											...
											<tr>
												<td><strong>Title:</strong></td>
												    <td><center><?php echo $rows['title']; ?></center></td>
													    <td><center>
													   <a href="javascript:void(0);" onClick="openNewTab('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="View User Details">
            ...
            <footer class="footer"> © 2023 - Online healthyfood Ordering System  </footer>
