...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logoku.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Restaurants HF<span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/bergizi.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Restaurant HF</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Dishes healthyfood of the Month</h2>
                    <p class="lead">Easiest way to order your favourite healthyfood among these top 6 dishes</p>
                </div>
                <div class="row">
						<?php 					
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a restaurant HF</h3>
                                    <p>We"ve got your covered with menus from a variety of delivery restaurants healthyfood online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a dish HF</h3>
                                <p>We"ve got your covered with a variety of delivery restaurants healthyfood online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your healthyfood delivered! And enjoy your meal! </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Restaurants HF</h4> </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                ...
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                   ...
                                   <p>Join thousands of other restaurants healthyfood who benefit from having partnered with us.</p>
                                </div>
                    </div>
                </div>
